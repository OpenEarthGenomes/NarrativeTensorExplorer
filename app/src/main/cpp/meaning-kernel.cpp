...
// 1. KVANTÁLT HASONLÓSÁG - NEON SIMD
...
Java_com_meaning_app_kernel_QuantizationEngine_fastNeonSimilarity(
    ...
    for (; i <= length - 16; i += 16) {
        ...
        // Alacsony és magas részek szorzata
        ...
        // Összegzés 32-bites regiszterekbe
...
// 2. 3D KOORDINÁTA TRANSZFORMÁCIÓ - Mátrix szorzás NEON-al
...
Java_com_meaning_app_kernel_QuantizationEngine_transform3DCoordinates(
    ...
    // Mátrix oszlopokra bontása NEON regiszterekbe
...
// 3. KVANTÁLÁS TÖMEGESEN - NEON gyorsítás
JNIEXPORT void JNICALL
Java_com_meaning_app_kernel_QuantizationEngine_quantizeBatch(
    ...
    for (int i = 0; i < count; i += 16) {
        // 4 float32 betöltése NEON regiszterekbe
